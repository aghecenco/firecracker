...
fn attach_legacy_devices(
    ...
    kernel_cmdline: &mut linux_loader::cmdline::Cmdline,
...
pub mod tests {
    ...
    pub(crate) fn default_kernel_cmdline() -> Cmdline {
        let mut kernel_cmdline = Cmdline::new(4096);
